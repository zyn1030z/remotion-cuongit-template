...
export const SubtitleBox: React.FC<SubtitleBoxProps> = ({
  ...
  return (
    ...
    >
      <div className="flex max-w-[960px] items-center gap-4 rounded-full border-2 border-indigo-400/50 bg-slate-950/95 px-10 py-5 shadow-[0_15px_40px_rgba(0,0,0,0.9)] backdrop-blur-2xl">
